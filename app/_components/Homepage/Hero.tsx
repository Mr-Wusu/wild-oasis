...
function Hero() {
  return (
    <div className="relative h-screen w-full top-0 left-0">
      ...
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-50 bg-transparent pointer-events-auto flex flex-col items-center gap-6">
