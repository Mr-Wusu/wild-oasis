...
import DateSelector from "@/app/_components/CabinComponents/DateSelector";
import BookingInfo from "@/app/_components/CabinComponents/BookingInfo";
...
export default async function CabinPage({ params }: Props) {
  ...
  const cabinId = awaitedParams.cabinId;
  ...
  return (
    <div className="max-w-7xl min-h-screen mx-auto font-josefineSans pb-13 text-primary-10 flex flex-col lg:gap-6 items-center justify-center ">
      <div className="px-4 sm:px-6 lg:px-8 pt-24 md:py-16 md:pt-26 ">
        <div
          className="
      ...
      <div className="flex flex-col  w-full mt-7 px-4 ">
        <h1 className="text-3xl text-center">
          Reserve {name} today. Pay on arrival
        </h1>
        <div className="flex flex-col gap-8 items-stretch lg:flex-row lg:justify-between lg:items-start">
          <DateSelector
            settings={settings}
            cabin={cabin}
